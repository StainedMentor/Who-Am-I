...
def streak():
    ...
    def rerun_level():
        ...
        if st.session_state.guesses2 == 0:
            st.session_state.current_lvl = 1
            st.session_state.streak = 0
            st.session_state.hints = 3
            st.session_state.score2 = 0
            ...
            score = st.session_state.tries * 10
    ...
    def gameOverInfo():
        ...
        with gameover.container():
            if st.session_state.tries <= 0:
                st.write("You have exceeded the number of available queries!")
            else:
            ...
            with temp2:
                if st.button("Try Again", type="primary", on_click=rerun_level):
                    pass
            with temp4:
